...
export default function Footer({
  ...
  contactAddress = '123 Innovation Drive, Tech Hub 100',
  newsletterTitle = 'Tech Insights',
  newsletterDisclaimer = 'Get weekly tech updates, industry insights, and product announcements. Unsubscribe anytime.',
