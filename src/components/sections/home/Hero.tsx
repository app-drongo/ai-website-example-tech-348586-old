...
const DEFAULT_HERO = {
  ...
  titleHighlight: '10x faster with AI',
  description:
    'Transform your ideas into scalable applications with our intelligent development platform. Ship features faster, reduce bugs, and scale effortlessly.',
  features: [
  ...
  imageAlt: 'AI-powered development dashboard',
  statsLabel1: 'Deploy Speed',
  statsValue1: '5x Faster',
  statsLabel2: 'Bug Reduction',
  statsValue2: '90% Less',
} as const;
